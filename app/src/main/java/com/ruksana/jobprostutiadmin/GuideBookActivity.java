...
public class GuideBookActivity extends AppCompatActivity {
    ...
    private String name, time, randomKey, data, category;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Add to Guide Book");
        ...
        dbroot.collection("Data")
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(GuideBookActivity.this, "Data is Inserted..", Toast.LENGTH_SHORT).show();
                        loadingBar.dismiss();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(GuideBookActivity.this, "An error occurred..Please try again later", Toast.LENGTH_SHORT).show();
                        loadingBar.dismiss();
                    }
                });
