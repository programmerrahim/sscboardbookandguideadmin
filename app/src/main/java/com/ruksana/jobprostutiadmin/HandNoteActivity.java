...
public class HandNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Add to Hand Note");
        ...
        dbroot.collection("Data")
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(HandNoteActivity.this, "Data is Inserted..", Toast.LENGTH_SHORT).show();
                        loadingBar.dismiss();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(HandNoteActivity.this, "An error occurred..Please try again later", Toast.LENGTH_SHORT).show();
                        loadingBar.dismiss();
                    }
                });
